    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http    
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/freelancers/search", "/api/v1/projects/search")
                        .authenticated()

                        // Application endpoints
                        .requestMatchers("/api/v1/projects/*/apply")
                        .hasRole("FREELANCER")
                        .requestMatchers("/api/v1/projects/*/applications")
                        .hasRole("CLIENT")
                        .requestMatchers("/api/v1/applications/*/accept", "/api/v1/applications/*/reject")
                        .hasRole("CLIENT")

                        // Project management endpoints
                        .requestMatchers(HttpMethod.POST, "/api/v1/projects")
                        .hasRole("CLIENT")
                        .requestMatchers(HttpMethod.GET, "/api/v1/projects/my")
                        .hasRole("CLIENT")
